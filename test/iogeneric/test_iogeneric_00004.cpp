...
//     delete writer;
    ...
    reader->setIOMode(0);
    reader->setDir("geodata");
    reader->setFilename("planarquads_mimmo");
    //reader->setFilename("naca0012sq");
    reader->setFileType(FileType::SQVTUPLANAR);
    reader->execute();
