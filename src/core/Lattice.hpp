...
REGISTER_PORT(M_GEOM, MC_SCALAR, MD_MIMMO_,__LATTICE_HPP__)
REGISTER_PORT(M_DIMENSION, MC_ARRAY3, MD_INT, __LATTICE_HPP__)
REGISTER_PORT(M_INFLIMITS, MC_ARRAY3, MD_FLOAT, __LATTICE_HPP__)
REGISTER_PORT(M_AXES, MC_ARR3ARR3, MD_FLOAT, __LATTICE_HPP__)
REGISTER_PORT(M_SPAN, MC_ARRAY3, MD_FLOAT, __LATTICE_HPP__)
REGISTER_PORT(M_POINT, MC_ARRAY3, MD_FLOAT, __LATTICE_HPP__)
REGISTER_PORT(M_SHAPE, MC_SCALAR, MD_SHAPET, __LATTICE_HPP__)
REGISTER_PORT(M_COPYSHAPE, MC_SCALAR, MD_SHAPE_, __LATTICE_HPP__)
REGISTER_PORT(M_SHAPEI, MC_SCALAR, MD_INT, __LATTICE_HPP__)
REGISTER_PORT(M_GLOBAL, MC_VECARR3, MD_FLOAT, __LATTICE_HPP__)
REGISTER_PORT(M_LOCAL, MC_VECARR3, MD_FLOAT, __LATTICE_HPP__)
