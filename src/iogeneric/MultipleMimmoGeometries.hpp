...
REGISTER_PORT(M_VECGEOM, MC_VECTOR, MD_MIMMO_,__MULTIPLEMIMMOGEOMETRIES_HPP__)
REGISTER_PORT(M_MAPGEOM, MC_UN_MAP, MD_STRINGPAIRINTMIMMO_,__MULTIPLEMIMMOGEOMETRIES_HPP__)
REGISTER_PORT(M_FINFO, MC_VECTOR, MD_FILEINFODATA,__MULTIPLEMIMMOGEOMETRIES_HPP__)
REGISTER_PORT(M_FINFO2, MC_VECTOR, MD_FILEINFODATA,__MULTIPLEMIMMOGEOMETRIES_HPP__)
