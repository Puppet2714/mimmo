...
REGISTER_PORT(M_PAIRVECFIELD, MC_PAIR, MD_MIMMO_VECARR3FLOAT_, __OVERLAPPINGFIELDS_HPP__)
REGISTER_PORT(M_UMGEOVFD, MC_UN_MAP, MD_MIMMO_VECARR3FLOAT_, __OVERLAPPINGFIELDS_HPP__)
REGISTER_PORT(M_VECPAIRVF, MC_VECTOR, MD_PAIRMIMMO_VECARR3FLOAT_, __OVERLAPPINGFIELDS_HPP__)
REGISTER_PORT(M_PAIRSCAFIELD, MC_PAIR, MD_MIMMO_VECFLOAT_, __OVERLAPPINGFIELDS_HPP__)
REGISTER_PORT(M_UMGEOSFD, MC_UN_MAP, MD_MIMMO_VECFLOAT_, __OVERLAPPINGFIELDS_HPP__)
REGISTER_PORT(M_VECPAIRSF, MC_VECTOR, MD_PAIRMIMMO_VECFLOAT_, __OVERLAPPINGFIELDS_HPP__)
