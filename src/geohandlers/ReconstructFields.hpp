 ...
 *
     ...
     | M_PAIRSCAFIELD | setData            | (MC_PAIR, MD_MIMMO_VECFLOAT_)          |
     | M_GEOM         | m_geometry         | (MC_SCALAR, MD_MIMMO_)                 |
     | M_VECPAIRSF    | setData            | (MC_VECTOR, MD_PAIRMIMMO_VECFLOAT_)    |
     ...
     |----------------|--------------------|-----------------------|
     | <B>PortType</B>   | <B>variable/function</B>  |<B>DataType</B> |
     | M_SCALARFIELD  | getResultField     | (MC_VECTOR, MD_FLOAT)       |
     | M_GEOM         | getGeometry        | (MC_SCALAR, MD_MIMMO_)      |
     | M_PAIRSCAFIELD | getResultFieldPair | (MC_PAIR, MD_MIMMO_VECFLOAT_)|
 ...
 *
     ...
     |----------------|--------------------|------------------------------------|
     | <B>PortType</B>   | <B>variable/function</B>  |<B>DataType</B> |
     | M_PAIRVECFIELD | setData            | (MC_PAIR, MD_MIMMO_VECARR3FLOAT_)        |
     | M_GEOM         | m_geometry         | (MC_SCALAR, MD_MIMMO_)                   |
     | M_VECPAIRVF    | setData            | (MC_VECTOR, MD_PAIRMIMMO_VECARR3FLOAT_)  |

     |             Port Output  ||                                                |
     |----------------|--------------------|----------------------------|
     | <B>PortType</B>   | <B>variable/function</B>  |<B>DataType</B> |
     | M_GDISPL       | getResultField     | (MC_VECARR3, MD_FLOAT)           |
     | M_GEOM         | getGeometry        | (MC_SCALAR, MD_MIMMO_)           |
     | M_PAIRVECFIELD | getResultFieldPair | (MC_PAIR, MD_MIMMO_VECARR3FLOAT_)|
...
REGISTER_PORT(M_PAIRVECFIELD, MC_PAIR, MD_MIMMO_VECARR3FLOAT_, __RECONSTRUCTSCALAR_HPP__)
REGISTER_PORT(M_VECPAIRVF, MC_VECTOR, MD_PAIRMIMMO_VECARR3FLOAT_, __RECONSTRUCTSCALAR_HPP__)
REGISTER_PORT(M_GDISPLS, MC_VECARR3, MD_FLOAT, __RECONSTRUCTSCALAR_HPP__)
REGISTER_PORT(M_PAIRSCAFIELD, MC_PAIR, MD_MIMMO_VECFLOAT_, __RECONSTRUCTSCALAR_HPP__)
REGISTER_PORT(M_GEOM, MC_SCALAR, MD_MIMMO_, __RECONSTRUCTSCALAR_HPP__)
REGISTER_PORT(M_VECPAIRSF, MC_VECTOR, MD_PAIRMIMMO_VECFLOAT_, __RECONSTRUCTSCALAR_HPP__)
REGISTER_PORT(M_SCALARFIELD, MC_VECTOR, MD_FLOAT, __RECONSTRUCTSCALAR_HPP__)
