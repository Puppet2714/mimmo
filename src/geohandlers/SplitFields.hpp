...
REGISTER_PORT(M_GEOM, MC_SCALAR, MD_MIMMO_ ,__SPLITFIELDS_HPP__)
REGISTER_PORT(M_VECGEOM, MC_VECTOR, MD_MIMMO_,__SPLITFIELDS_HPP__)
REGISTER_PORT(M_MAPDCELL, MC_UN_MAP, MD_LONGPAIRINTLONG,__SPLITFIELDS_HPP__)
REGISTER_PORT(M_MAPDVERT, MC_UN_MAP, MD_LONGPAIRINTLONG,__SPLITFIELDS_HPP__)
REGISTER_PORT(M_SCALARFIELD, MC_VECTOR, MD_FLOAT,__SPLITFIELDS_HPP__)
REGISTER_PORT(M_UMGEOSFD, MC_UN_MAP, MD_MIMMO_VECFLOAT_,__SPLITFIELDS_HPP__)
REGISTER_PORT(M_GDISPLS, MC_VECARR3, MD_FLOAT,__SPLITFIELDS_HPP__)
REGISTER_PORT(M_UMGEOVFD, MC_UN_MAP, MD_MIMMO_VECARR3FLOAT_,__SPLITFIELDS_HPP__)
